...
write_r::write_r(sc_module_name name) : sc_module(name), mVcdFile(0) {
    softmax_mul_mul_1cud_U54 = new softmax_mul_mul_1cud<1,1,12,16,28>("softmax_mul_mul_1cud_U54");
    softmax_mul_mul_1cud_U54->din0(bound_fu_626_p0);
    softmax_mul_mul_1cud_U54->din1(bound_fu_626_p1);
    softmax_mul_mul_1cud_U54->dout(bound_fu_626_p2);
...
write_r::~write_r() {
    ...
    delete softmax_mul_mul_1cud_U54;
}
