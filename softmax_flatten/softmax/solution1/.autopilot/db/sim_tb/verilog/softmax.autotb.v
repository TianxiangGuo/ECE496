...
`define AUTOTB_TVIN_in_V_data_V  "./c.softmax.autotvin_in_V_data_V.dat"
`define AUTOTB_TVIN_in_V_id_V  "./c.softmax.autotvin_in_V_id_V.dat"
`define AUTOTB_TVIN_in_V_dest_V  "./c.softmax.autotvin_in_V_dest_V.dat"
`define AUTOTB_TVIN_in_V_user_V  "./c.softmax.autotvin_in_V_user_V.dat"
`define AUTOTB_TVIN_in_V_last_V  "./c.softmax.autotvin_in_V_last_V.dat"
`define AUTOTB_TVIN_out_V_data_V  "./c.softmax.autotvin_out_V_data_V.dat"
`define AUTOTB_TVIN_out_V_id_V  "./c.softmax.autotvin_out_V_id_V.dat"
`define AUTOTB_TVIN_out_V_dest_V  "./c.softmax.autotvin_out_V_dest_V.dat"
`define AUTOTB_TVIN_out_V_user_V  "./c.softmax.autotvin_out_V_user_V.dat"
`define AUTOTB_TVIN_out_V_last_V  "./c.softmax.autotvin_out_V_last_V.dat"
`define AUTOTB_TVIN_in_V_data_V_out_wrapc  "./rtl.softmax.autotvin_in_V_data_V.dat"
`define AUTOTB_TVIN_in_V_id_V_out_wrapc  "./rtl.softmax.autotvin_in_V_id_V.dat"
`define AUTOTB_TVIN_in_V_dest_V_out_wrapc  "./rtl.softmax.autotvin_in_V_dest_V.dat"
`define AUTOTB_TVIN_in_V_user_V_out_wrapc  "./rtl.softmax.autotvin_in_V_user_V.dat"
`define AUTOTB_TVIN_in_V_last_V_out_wrapc  "./rtl.softmax.autotvin_in_V_last_V.dat"
`define AUTOTB_TVIN_out_V_data_V_out_wrapc  "./rtl.softmax.autotvin_out_V_data_V.dat"
`define AUTOTB_TVIN_out_V_id_V_out_wrapc  "./rtl.softmax.autotvin_out_V_id_V.dat"
`define AUTOTB_TVIN_out_V_dest_V_out_wrapc  "./rtl.softmax.autotvin_out_V_dest_V.dat"
`define AUTOTB_TVIN_out_V_user_V_out_wrapc  "./rtl.softmax.autotvin_out_V_user_V.dat"
`define AUTOTB_TVIN_out_V_last_V_out_wrapc  "./rtl.softmax.autotvin_out_V_last_V.dat"
`define AUTOTB_TVOUT_out_V_data_V  "./c.softmax.autotvout_out_V_data_V.dat"
`define AUTOTB_TVOUT_out_V_id_V  "./c.softmax.autotvout_out_V_id_V.dat"
`define AUTOTB_TVOUT_out_V_dest_V  "./c.softmax.autotvout_out_V_dest_V.dat"
`define AUTOTB_TVOUT_out_V_user_V  "./c.softmax.autotvout_out_V_user_V.dat"
`define AUTOTB_TVOUT_out_V_last_V  "./c.softmax.autotvout_out_V_last_V.dat"
`define AUTOTB_TVOUT_out_V_data_V_out_wrapc  "./impl_rtl.softmax.autotvout_out_V_data_V.dat"
`define AUTOTB_TVOUT_out_V_id_V_out_wrapc  "./impl_rtl.softmax.autotvout_out_V_id_V.dat"
`define AUTOTB_TVOUT_out_V_dest_V_out_wrapc  "./impl_rtl.softmax.autotvout_out_V_dest_V.dat"
`define AUTOTB_TVOUT_out_V_user_V_out_wrapc  "./impl_rtl.softmax.autotvout_out_V_user_V.dat"
`define AUTOTB_TVOUT_out_V_last_V_out_wrapc  "./impl_rtl.softmax.autotvout_out_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_in_V_data_V = 17;
parameter LENGTH_in_V_id_V = 17;
parameter LENGTH_in_V_dest_V = 17;
parameter LENGTH_in_V_user_V = 17;
parameter LENGTH_in_V_last_V = 17;
parameter LENGTH_out_V_data_V = 5;
parameter LENGTH_out_V_id_V = 5;
parameter LENGTH_out_V_dest_V = 5;
parameter LENGTH_out_V_user_V = 5;
parameter LENGTH_out_V_last_V = 5;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.softmax.autotvout_out_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.softmax.autotvout_out_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.softmax.autotvout_out_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.softmax.autotvout_out_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.softmax.autotvout_out_V_data_V.dat with impl_rtl.softmax.autotvout_out_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.softmax.autotvout_out_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.softmax.autotvout_out_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.softmax.autotvout_out_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.softmax.autotvout_out_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.softmax.autotvout_out_V_id_V.dat with impl_rtl.softmax.autotvout_out_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.softmax.autotvout_out_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.softmax.autotvout_out_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.softmax.autotvout_out_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.softmax.autotvout_out_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.softmax.autotvout_out_V_dest_V.dat with impl_rtl.softmax.autotvout_out_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.softmax.autotvout_out_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.softmax.autotvout_out_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.softmax.autotvout_out_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.softmax.autotvout_out_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.softmax.autotvout_out_V_user_V.dat with impl_rtl.softmax.autotvout_out_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.softmax.autotvout_out_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.softmax.autotvout_out_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.softmax.autotvout_out_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.softmax.autotvout_out_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.softmax.autotvout_out_V_last_V.dat with impl_rtl.softmax.autotvout_out_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_OUT_out_V_data_V "./stream_size_out_out_V_data_V.dat"
    ...
    `define STREAM_SIZE_OUT_out_V_id_V "./stream_size_out_out_V_id_V.dat"
    ...
    `define STREAM_SIZE_OUT_out_V_dest_V "./stream_size_out_out_V_dest_V.dat"
    ...
    `define STREAM_SIZE_OUT_out_V_user_V "./stream_size_out_out_V_user_V.dat"
    ...
    `define STREAM_SIZE_OUT_out_V_last_V "./stream_size_out_out_V_last_V.dat"
