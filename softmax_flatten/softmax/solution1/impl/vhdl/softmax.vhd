...
architecture behav of softmax is 
    ...
    "softmax,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu19eg-ffvc1760-2-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.320000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=132,HLS_SYN_DSP=370,HLS_SYN_FF=26027,HLS_SYN_LUT=32799,HLS_VERSION=2018_3}";
    ...
    signal QuantAct_1_channel_U0_ap_start : STD_LOGIC;
    signal QuantAct_1_channel_U0_ap_done : STD_LOGIC;
    signal QuantAct_1_channel_U0_ap_continue : STD_LOGIC;
    signal QuantAct_1_channel_U0_ap_idle : STD_LOGIC;
    signal QuantAct_1_channel_U0_ap_ready : STD_LOGIC;
    signal QuantAct_1_channel_U0_start_out : STD_LOGIC;
    signal QuantAct_1_channel_U0_start_write : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_quant_iter_c_V_V_read : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_quant_iter_r_V_V_read : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_proc_2_iter_r_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal QuantAct_1_channel_U0_in_proc_2_iter_r_V_V_write : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_proc_2_iter_c_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal QuantAct_1_channel_U0_in_proc_2_iter_c_V_V_write : STD_LOGIC;
    signal QuantAct_1_channel_U0_sum_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal QuantAct_1_channel_U0_sum_V_V_write : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_quant_V_V_read : STD_LOGIC;
    signal QuantAct_1_channel_U0_in_proc_2_V_V_din : STD_LOGIC_VECTOR (255 downto 0);
    signal QuantAct_1_channel_U0_in_proc_2_V_V_write : STD_LOGIC;
    signal divide_U0_ap_start : STD_LOGIC;
    signal divide_U0_ap_done : STD_LOGIC;
    signal divide_U0_ap_continue : STD_LOGIC;
    signal divide_U0_ap_idle : STD_LOGIC;
    signal divide_U0_ap_ready : STD_LOGIC;
    signal divide_U0_in_proc_2_iter_c_V_V_read : STD_LOGIC;
    signal divide_U0_in_proc_2_iter_r_V_V_read : STD_LOGIC;
    signal divide_U0_in_write_iter_c_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal divide_U0_in_write_iter_c_V_V_write : STD_LOGIC;
    signal divide_U0_sum_V_V_read : STD_LOGIC;
    signal divide_U0_in_proc_2_V_V_read : STD_LOGIC;
    signal divide_U0_in_write_V_V_din : STD_LOGIC_VECTOR (127 downto 0);
    signal divide_U0_in_write_V_V_write : STD_LOGIC;
    ...
    signal start_for_QuantAct_1_channel_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_QuantAct_1_channel_U0_full_n : STD_LOGIC;
    signal start_for_QuantAct_1_channel_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_QuantAct_1_channel_U0_empty_n : STD_LOGIC;
    signal start_for_divide_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_divide_U0_full_n : STD_LOGIC;
    signal start_for_divide_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_divide_U0_empty_n : STD_LOGIC;
    signal divide_U0_start_full_n : STD_LOGIC;
    signal divide_U0_start_write : STD_LOGIC;
    ...
    component QuantAct_1_channel IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_subtracdEe IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_processeOg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_QuantAcfYi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_divide_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    QuantAct_1_channel_U0 : component QuantAct_1_channel
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    start_for_subtracdEe_U : component start_for_subtracdEe
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_processeOg_U : component start_for_processeOg
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_QuantAcfYi_U : component start_for_QuantAcfYi
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_divide_U0_U : component start_for_divide_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    QuantAct_1_channel_U0_ap_start <= start_for_QuantAct_1_channel_U0_empty_n;
    ...
    divide_U0_ap_start <= start_for_divide_U0_empty_n;
    ...
    start_for_QuantAct_1_channel_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_divide_U0_din <= (0=>ap_const_logic_1, others=>'-');
