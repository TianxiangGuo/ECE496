# ==============================================================
# File generated on Wed Dec 28 18:56:47 -0500 2022
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "softmax.autotvin.dat"
	set constFileTvOut       "softmax.autotvout.dat"
	set constFileHdlTvIn     "softmax.autohdltvin.dat"
	set constFileHdlTvOut    "softmax.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
