// ==============================================================
// File generated on Wed Dec 28 18:56:48 -0500 2022
...
`define TV_OUT_out_r_TDATA "../tv/rtldatafile/rtl.softmax.autotvout_out_V_data_V.dat"
`define TV_OUT_out_r_TID "../tv/rtldatafile/rtl.softmax.autotvout_out_V_id_V.dat"
`define TV_OUT_out_r_TDEST "../tv/rtldatafile/rtl.softmax.autotvout_out_V_dest_V.dat"
`define TV_OUT_out_r_TUSER "../tv/rtldatafile/rtl.softmax.autotvout_out_V_user_V.dat"
`define TV_OUT_out_r_TLAST "../tv/rtldatafile/rtl.softmax.autotvout_out_V_last_V.dat"
...
module AESL_axi_s_out_r (
    input clk,
    input reset,
    input [512 - 1:0] TRAN_out_r_TDATA,
    input [8 - 1:0] TRAN_out_r_TID,
    input [8 - 1:0] TRAN_out_r_TDEST,
    input [16 - 1:0] TRAN_out_r_TUSER,
    ...
    reg [512 - 1:0] out_r_TDATA_write_data;
    reg out_r_TDATA_read_en;
    wire [512 - 1:0] out_r_TDATA_read_data;
    
    fifo #(5, 512) fifo_out_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] out_r_TID_write_data;
    reg out_r_TID_read_en;
    wire [8 - 1:0] out_r_TID_read_data;
    
    fifo #(5, 8) fifo_out_r_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] out_r_TDEST_write_data;
    reg out_r_TDEST_read_en;
    wire [8 - 1:0] out_r_TDEST_read_data;
    
    fifo #(5, 8) fifo_out_r_TDEST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [16 - 1:0] out_r_TUSER_write_data;
    reg out_r_TUSER_read_en;
    wire [16 - 1:0] out_r_TUSER_read_data;
    
    fifo #(5, 16) fifo_out_r_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_out_r_TREADY = ~(out_r_TDATA_full || out_r_TID_full || out_r_TDEST_full || out_r_TUSER_full || out_r_TLAST_full);
