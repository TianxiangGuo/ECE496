# ==============================================================
# File generated on Wed Dec 28 19:19:56 -0500 2022
...
HLS_SOURCES = ../../../../main.cpp ../../../../top_incremental.cpp
...
$(ObjDir)/top_incremental.o: ../../../../top_incremental.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../top_incremental.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/top_incremental.d
