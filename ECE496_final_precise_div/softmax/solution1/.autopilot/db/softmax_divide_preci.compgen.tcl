...
eval "cg_default_interface_gen_dc { \
    id 67 \
    name in_write_iter_c_V_V \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_in_write_iter_c_V_V \
    op interface \
    ports { in_write_iter_c_V_V_din { O 32 vector } in_write_iter_c_V_V_full_n { I 1 bit } in_write_iter_c_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_proc_2_V_V_dout { I 256 vector } in_proc_2_V_V_empty_n { I 1 bit } in_proc_2_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_write_V_V_din { O 128 vector } in_write_V_V_full_n { I 1 bit } in_write_V_V_write { O 1 bit } } \
} "
}
