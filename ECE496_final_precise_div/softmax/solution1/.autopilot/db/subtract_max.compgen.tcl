...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_sub_max_V_V_dout { I 512 vector } in_sub_max_V_V_empty_n { I 1 bit } in_sub_max_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_proc_1_V_V_din { O 512 vector } in_proc_1_V_V_full_n { I 1 bit } in_proc_1_V_V_write { O 1 bit } } \
} "
}
