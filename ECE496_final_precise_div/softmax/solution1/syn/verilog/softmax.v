...
wire    QuantAct_1_channel_m_U0_ap_start;
wire    QuantAct_1_channel_m_U0_ap_done;
wire    QuantAct_1_channel_m_U0_ap_continue;
wire    QuantAct_1_channel_m_U0_ap_idle;
wire    QuantAct_1_channel_m_U0_ap_ready;
wire    QuantAct_1_channel_m_U0_start_out;
wire    QuantAct_1_channel_m_U0_start_write;
wire    QuantAct_1_channel_m_U0_in_quant_iter_c_V_V_read;
wire    QuantAct_1_channel_m_U0_in_quant_iter_r_V_V_read;
wire   [31:0] QuantAct_1_channel_m_U0_in_proc_2_iter_r_V_V_din;
wire    QuantAct_1_channel_m_U0_in_proc_2_iter_r_V_V_write;
wire   [31:0] QuantAct_1_channel_m_U0_in_proc_2_iter_c_V_V_din;
wire    QuantAct_1_channel_m_U0_in_proc_2_iter_c_V_V_write;
wire   [31:0] QuantAct_1_channel_m_U0_sum_V_V_din;
wire    QuantAct_1_channel_m_U0_sum_V_V_write;
wire    QuantAct_1_channel_m_U0_in_quant_V_V_read;
wire   [255:0] QuantAct_1_channel_m_U0_in_proc_2_V_V_din;
wire    QuantAct_1_channel_m_U0_in_proc_2_V_V_write;
...
wire   [31:0] softmax_divide_preci_U0_in_write_iter_c_V_V_din;
wire    softmax_divide_preci_U0_in_write_iter_c_V_V_write;
wire    softmax_divide_preci_U0_sum_V_V_read;
wire    softmax_divide_preci_U0_in_proc_2_V_V_read;
wire   [127:0] softmax_divide_preci_U0_in_write_V_V_din;
...
wire   [0:0] start_for_QuantAct_1_channel_m_U0_din;
wire    start_for_QuantAct_1_channel_m_U0_full_n;
wire   [0:0] start_for_QuantAct_1_channel_m_U0_dout;
wire    start_for_QuantAct_1_channel_m_U0_empty_n;
...
QuantAct_1_channel_m QuantAct_1_channel_m_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
start_for_subtraceOg start_for_subtraceOg_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_processfYi start_for_processfYi_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_QuantAcg8j start_for_QuantAcg8j_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_softmaxhbi start_for_softmaxhbi_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign QuantAct_1_channel_m_U0_ap_continue = 1'b1;

assign QuantAct_1_channel_m_U0_ap_start = start_for_QuantAct_1_channel_m_U0_empty_n;
...
assign start_for_QuantAct_1_channel_m_U0_din = 1'b1;
