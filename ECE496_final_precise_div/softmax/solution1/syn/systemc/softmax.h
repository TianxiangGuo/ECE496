...
#include "start_for_subtraceOg.h"
#include "start_for_write_U0.h"
#include "start_for_processfYi.h"
#include "start_for_QuantAcg8j.h"
#include "start_for_softmaxhbi.h"
...
struct softmax : public sc_module {
    ...
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_ap_start;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_ap_done;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_ap_continue;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_ap_idle;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_ap_ready;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_start_out;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_start_write;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_quant_iter_c_V_V_read;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_quant_iter_r_V_V_read;
    sc_signal< sc_lv<32> > QuantAct_1_channel_m_U0_in_proc_2_iter_r_V_V_din;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_proc_2_iter_r_V_V_write;
    sc_signal< sc_lv<32> > QuantAct_1_channel_m_U0_in_proc_2_iter_c_V_V_din;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_proc_2_iter_c_V_V_write;
    sc_signal< sc_lv<32> > QuantAct_1_channel_m_U0_sum_V_V_din;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_sum_V_V_write;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_quant_V_V_read;
    sc_signal< sc_lv<256> > QuantAct_1_channel_m_U0_in_proc_2_V_V_din;
    sc_signal< sc_logic > QuantAct_1_channel_m_U0_in_proc_2_V_V_write;
    ...
    sc_signal< sc_lv<32> > softmax_divide_preci_U0_in_write_iter_c_V_V_din;
    sc_signal< sc_logic > softmax_divide_preci_U0_in_write_iter_c_V_V_write;
    sc_signal< sc_logic > softmax_divide_preci_U0_sum_V_V_read;
    sc_signal< sc_logic > softmax_divide_preci_U0_in_proc_2_V_V_read;
    sc_signal< sc_lv<128> > softmax_divide_preci_U0_in_write_V_V_din;
    ...
    sc_signal< sc_lv<1> > start_for_QuantAct_1_channel_m_U0_din;
    sc_signal< sc_logic > start_for_QuantAct_1_channel_m_U0_full_n;
    sc_signal< sc_lv<1> > start_for_QuantAct_1_channel_m_U0_dout;
    sc_signal< sc_logic > start_for_QuantAct_1_channel_m_U0_empty_n;
    ...
    void thread_QuantAct_1_channel_m_U0_ap_continue();
    void thread_QuantAct_1_channel_m_U0_ap_start();
    ...
    void thread_start_for_QuantAct_1_channel_m_U0_din();
