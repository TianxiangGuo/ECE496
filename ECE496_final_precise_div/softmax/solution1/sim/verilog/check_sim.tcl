...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.softmax.autotvin_in_V_data_V.dat"
         "c.softmax.autotvin_in_V_id_V.dat"
         "c.softmax.autotvin_in_V_dest_V.dat"
         "c.softmax.autotvin_in_V_user_V.dat"
         "c.softmax.autotvin_in_V_last_V.dat"
         "c.softmax.autotvin_out_V_data_V.dat"
         "c.softmax.autotvin_out_V_id_V.dat"
         "c.softmax.autotvin_out_V_dest_V.dat"
         "c.softmax.autotvin_out_V_user_V.dat"
         "c.softmax.autotvin_out_V_last_V.dat"
         "c.softmax.autotvout_out_V_data_V.dat"
         "c.softmax.autotvout_out_V_id_V.dat"
         "c.softmax.autotvout_out_V_dest_V.dat"
         "c.softmax.autotvout_out_V_user_V.dat"
         "c.softmax.autotvout_out_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.softmax.autotvout_out_V_data_V.dat"
         "rtl.softmax.autotvout_out_V_id_V.dat"
         "rtl.softmax.autotvout_out_V_dest_V.dat"
         "rtl.softmax.autotvout_out_V_user_V.dat"
         "rtl.softmax.autotvout_out_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
