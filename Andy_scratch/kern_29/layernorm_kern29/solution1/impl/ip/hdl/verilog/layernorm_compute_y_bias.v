...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module layernorm_compute_y_bias_rom (
...
initial begin
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram0);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram1);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram2);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram3);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram4);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram5);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram6);
    $readmemh("./layernorm_compute_y_bias_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module layernorm_compute_y_bias(
    reset,
    clk,
    address0,
    ce0,
...
layernorm_compute_y_bias_rom layernorm_compute_y_bias_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
