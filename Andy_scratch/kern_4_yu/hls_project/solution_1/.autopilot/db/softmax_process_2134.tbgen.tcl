set moduleName softmax_process_2134
set isTopModule 0
...
set C_modelName {softmax_process_2134}
...
set portList { 
	...
	{ in_V_V_dout sc_in sc_lv 32 signal 2 } 
	{ in_V_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ in_V_V_read sc_out sc_logic 1 signal 2 } 
	{ out_iter_c_V_V_din sc_out sc_lv 32 signal 3 } 
	{ out_iter_c_V_V_full_n sc_in sc_logic 1 signal 3 } 
	{ out_iter_c_V_V_write sc_out sc_logic 1 signal 3 } 
	{ out_V_V_din sc_out sc_lv 16 signal 4 } 
	{ out_V_V_full_n sc_in sc_logic 1 signal 4 } 
	{ out_V_V_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_sdiv_32s_32ns_8_36_1_U784", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_mux_646_32_1_1_U785", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_sdiv_32s_32ns_8_36_1_U786", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "57", "Max" : "86017"}
	, {"Name" : "Interval", "Min" : "57", "Max" : "86017"}
]}
