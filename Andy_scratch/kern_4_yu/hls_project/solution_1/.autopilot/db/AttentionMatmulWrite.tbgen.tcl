...
set C_modelArgList {
	...
	{ in_0_V_V int 32 regular {fifo 0 volatile }  }
	{ in_1_V_V int 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_n_r_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_0_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "in_1_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_0_V_V_dout sc_in sc_lv 32 signal 2 } 
	{ in_0_V_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ in_0_V_V_read sc_out sc_logic 1 signal 2 } 
	{ in_1_V_V_dout sc_in sc_lv 32 signal 3 } 
	{ in_1_V_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ in_1_V_V_read sc_out sc_logic 1 signal 3 } 
	{ out_V_data_V_din sc_out sc_lv 512 signal 4 } 
	{ out_V_data_V_full_n sc_in sc_logic 1 signal 4 } 
	{ out_V_data_V_write sc_out sc_logic 1 signal 4 } 
	{ out_V_id_V_din sc_out sc_lv 8 signal 5 } 
	{ out_V_id_V_full_n sc_in sc_logic 1 signal 5 } 
	{ out_V_id_V_write sc_out sc_logic 1 signal 5 } 
	{ out_V_dest_V_din sc_out sc_lv 8 signal 6 } 
	{ out_V_dest_V_full_n sc_in sc_logic 1 signal 6 } 
	{ out_V_dest_V_write sc_out sc_logic 1 signal 6 } 
	{ out_V_user_V_din sc_out sc_lv 16 signal 7 } 
	{ out_V_user_V_full_n sc_in sc_logic 1 signal 7 } 
	{ out_V_user_V_write sc_out sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_0_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_0_V_V", "role": "dout" }} , 
 	...
 	{ "name": "in_1_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_1_V_V", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_mul_mul_16ns_16ns_32_1_1_U500", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "132", "Max" : "8196"}
	, {"Name" : "Interval", "Min" : "132", "Max" : "8196"}
]}
...
set Spec2ImplPortList { 
	...
	in_0_V_V { ap_fifo {  { in_0_V_V_dout fifo_data 0 32 }  { in_0_V_V_empty_n fifo_status 0 1 }  { in_0_V_V_read fifo_update 1 1 } } }
	in_1_V_V { ap_fifo {  { in_1_V_V_dout fifo_data 0 32 }  { in_1_V_V_empty_n fifo_status 0 1 }  { in_1_V_V_read fifo_update 1 1 } } }
