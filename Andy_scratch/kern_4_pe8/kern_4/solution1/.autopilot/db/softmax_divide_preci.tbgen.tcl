...
set C_modelArgList {
	...
	{ in_write_2_iter_c_V_s int 32 regular {fifo 1 volatile } {global 1}  }
	{ sum_V_V int 32 regular {fifo 0 volatile } {global 0}  }
	{ in_proc_2_V_V int 16 regular {fifo 0 volatile } {global 0}  }
	{ in_write_V_V int 8 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_proc_2_iter_c_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "in_write_2_iter_c_V_s", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "sum_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "in_proc_2_V_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "in_write_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ in_write_2_iter_c_V_s_din sc_out sc_lv 32 signal 2 } 
	{ in_write_2_iter_c_V_s_full_n sc_in sc_logic 1 signal 2 } 
	{ in_write_2_iter_c_V_s_write sc_out sc_logic 1 signal 2 } 
	{ sum_V_V_dout sc_in sc_lv 32 signal 3 } 
	{ sum_V_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ sum_V_V_read sc_out sc_logic 1 signal 3 } 
	{ in_proc_2_V_V_dout sc_in sc_lv 16 signal 4 } 
	{ in_proc_2_V_V_empty_n sc_in sc_logic 1 signal 4 } 
	{ in_proc_2_V_V_read sc_out sc_logic 1 signal 4 } 
	{ in_write_V_V_din sc_out sc_lv 8 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_write_2_iter_c_V_s_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "din" }} , 
 	{ "name": "in_write_2_iter_c_V_s_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "full_n" }} , 
 	{ "name": "in_write_2_iter_c_V_s_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "write" }} , 
 	...
 	{ "name": "in_proc_2_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_proc_2_V_V", "role": "dout" }} , 
 	...
 	{ "name": "in_write_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_write_V_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "in_write_2_iter_c_V_s", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_sdiv_26ns_32ns_32_30_1_U1926", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	in_write_2_iter_c_V_s { ap_fifo {  { in_write_2_iter_c_V_s_din fifo_data 1 32 }  { in_write_2_iter_c_V_s_full_n fifo_status 0 1 }  { in_write_2_iter_c_V_s_write fifo_update 1 1 } } }
	sum_V_V { ap_fifo {  { sum_V_V_dout fifo_data 0 32 }  { sum_V_V_empty_n fifo_status 0 1 }  { sum_V_V_read fifo_update 1 1 } } }
	in_proc_2_V_V { ap_fifo {  { in_proc_2_V_V_dout fifo_data 0 16 }  { in_proc_2_V_V_empty_n fifo_status 0 1 }  { in_proc_2_V_V_read fifo_update 1 1 } } }
	in_write_V_V { ap_fifo {  { in_write_V_V_din fifo_data 1 8 }  { in_write_V_V_full_n fifo_status 0 1 }  { in_write_V_V_write fifo_update 1 1 } } }
}
