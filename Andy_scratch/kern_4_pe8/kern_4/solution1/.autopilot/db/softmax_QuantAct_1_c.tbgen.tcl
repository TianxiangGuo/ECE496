...
set C_modelArgList {
	...
	{ in_quant_V_V int 64 regular {fifo 0 volatile } {global 0}  }
	{ in_proc_2_V_V int 16 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_quant_iter_c_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "in_quant_V_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "in_proc_2_V_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_quant_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "in_quant_V_V", "role": "dout" }} , 
 	...
 	{ "name": "in_proc_2_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_proc_2_V_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_mul_32ns_64s_95_2_1_U1917", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "23", "Max" : "65543"}
	, {"Name" : "Interval", "Min" : "23", "Max" : "65543"}
]}
...
set Spec2ImplPortList { 
	...
	in_quant_V_V { ap_fifo {  { in_quant_V_V_dout fifo_data 0 64 }  { in_quant_V_V_empty_n fifo_status 0 1 }  { in_quant_V_V_read fifo_update 1 1 } } }
	in_proc_2_V_V { ap_fifo {  { in_proc_2_V_V_din fifo_data 1 16 }  { in_proc_2_V_V_full_n fifo_status 0 1 }  { in_proc_2_V_V_write fifo_update 1 1 } } }
}
