set moduleName softmax_subtract_max
...
set C_modelName {softmax_subtract_max}
...
set C_modelArgList {
	...
	{ in_sub_max_V_V int 32 regular {fifo 0 volatile } {global 0}  }
	{ in_proc_1_V_V int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_sub_max_c_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "in_sub_max_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "in_proc_1_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_sub_max_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_sub_max_V_V", "role": "dout" }} , 
 	...
 	{ "name": "in_proc_1_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_proc_1_V_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	in_sub_max_V_V { ap_fifo {  { in_sub_max_V_V_dout fifo_data 0 32 }  { in_sub_max_V_V_empty_n fifo_status 0 1 }  { in_sub_max_V_V_read fifo_update 1 1 } } }
	in_proc_1_V_V { ap_fifo {  { in_proc_1_V_V_din fifo_data 1 32 }  { in_proc_1_V_V_full_n fifo_status 0 1 }  { in_proc_1_V_V_write fifo_update 1 1 } } }
}
