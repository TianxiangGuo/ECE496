set moduleName softmax_write_out
...
set C_modelName {softmax_write_out}
...
set C_modelArgList {
	...
	{ in_write_2_iter_c_V_s int 32 regular {fifo 0 volatile } {global 0}  }
	{ in_write_V_V int 8 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "in_write_2_iter_c_V_s", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "in_write_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ in_write_2_iter_c_V_s_dout sc_in sc_lv 32 signal 6 } 
	{ in_write_2_iter_c_V_s_empty_n sc_in sc_logic 1 signal 6 } 
	{ in_write_2_iter_c_V_s_read sc_out sc_logic 1 signal 6 } 
	{ in_write_V_V_dout sc_in sc_lv 8 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_write_2_iter_c_V_s_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "dout" }} , 
 	{ "name": "in_write_2_iter_c_V_s_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "empty_n" }} , 
 	{ "name": "in_write_2_iter_c_V_s_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_write_2_iter_c_V_s", "role": "read" }} , 
 	{ "name": "in_write_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_write_V_V", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "in_write_2_iter_c_V_s", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_4_mul_mul_16ns_16ns_32_1_1_U1934", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	in_write_2_iter_c_V_s { ap_fifo {  { in_write_2_iter_c_V_s_dout fifo_data 0 32 }  { in_write_2_iter_c_V_s_empty_n fifo_status 0 1 }  { in_write_2_iter_c_V_s_read fifo_update 1 1 } } }
	in_write_V_V { ap_fifo {  { in_write_V_V_dout fifo_data 0 8 }  { in_write_V_V_empty_n fifo_status 0 1 }  { in_write_V_V_read fifo_update 1 1 } } }
}
