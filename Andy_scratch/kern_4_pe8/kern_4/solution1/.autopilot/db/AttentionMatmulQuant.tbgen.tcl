set moduleName AttentionMatmulQuant
...
set C_modelName {AttentionMatmulQuant}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V_data_V1 int 512 regular {fifo 0 volatile }  }
	{ in_V_id_V2 int 8 regular {fifo 0 volatile }  }
	{ in_V_dest_V3 int 8 regular {fifo 0 volatile }  }
	{ in_V_user_V4 int 16 regular {fifo 0 volatile }  }
	{ in_V_last_V5 int 1 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_V_data_V1", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "in_V_id_V2", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "in_V_dest_V3", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "in_V_user_V4", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "in_V_last_V5", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_V_data_V1_dout sc_in sc_lv 512 signal 0 } 
	{ in_V_data_V1_empty_n sc_in sc_logic 1 signal 0 } 
	{ in_V_data_V1_read sc_out sc_logic 1 signal 0 } 
	{ in_V_id_V2_dout sc_in sc_lv 8 signal 1 } 
	{ in_V_id_V2_empty_n sc_in sc_logic 1 signal 1 } 
	{ in_V_id_V2_read sc_out sc_logic 1 signal 1 } 
	{ in_V_dest_V3_dout sc_in sc_lv 8 signal 2 } 
	{ in_V_dest_V3_empty_n sc_in sc_logic 1 signal 2 } 
	{ in_V_dest_V3_read sc_out sc_logic 1 signal 2 } 
	{ in_V_user_V4_dout sc_in sc_lv 16 signal 3 } 
	{ in_V_user_V4_empty_n sc_in sc_logic 1 signal 3 } 
	{ in_V_user_V4_read sc_out sc_logic 1 signal 3 } 
	{ in_V_last_V5_dout sc_in sc_lv 1 signal 4 } 
	{ in_V_last_V5_empty_n sc_in sc_logic 1 signal 4 } 
	{ in_V_last_V5_read sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_data_V1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "in_V_data_V1", "role": "dout" }} , 
 	{ "name": "in_V_data_V1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_data_V1", "role": "empty_n" }} , 
 	{ "name": "in_V_data_V1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_data_V1", "role": "read" }} , 
 	{ "name": "in_V_id_V2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_V_id_V2", "role": "dout" }} , 
 	{ "name": "in_V_id_V2_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_id_V2", "role": "empty_n" }} , 
 	{ "name": "in_V_id_V2_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_id_V2", "role": "read" }} , 
 	{ "name": "in_V_dest_V3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_V_dest_V3", "role": "dout" }} , 
 	{ "name": "in_V_dest_V3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_dest_V3", "role": "empty_n" }} , 
 	{ "name": "in_V_dest_V3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_dest_V3", "role": "read" }} , 
 	{ "name": "in_V_user_V4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_V_user_V4", "role": "dout" }} , 
 	{ "name": "in_V_user_V4_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_user_V4", "role": "empty_n" }} , 
 	{ "name": "in_V_user_V4_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_user_V4", "role": "read" }} , 
 	{ "name": "in_V_last_V5_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_last_V5", "role": "dout" }} , 
 	{ "name": "in_V_last_V5_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_last_V5", "role": "empty_n" }} , 
 	{ "name": "in_V_last_V5_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_last_V5", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "in_V_data_V1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "in_V_data_V1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in_V_id_V2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "in_V_id_V2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in_V_dest_V3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "in_V_dest_V3_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in_V_user_V4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "in_V_user_V4_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in_V_last_V5", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11", "Max" : "131"}
	, {"Name" : "Interval", "Min" : "11", "Max" : "131"}
]}
...
set Spec2ImplPortList { 
	in_V_data_V1 { ap_fifo {  { in_V_data_V1_dout fifo_data 0 512 }  { in_V_data_V1_empty_n fifo_status 0 1 }  { in_V_data_V1_read fifo_update 1 1 } } }
	in_V_id_V2 { ap_fifo {  { in_V_id_V2_dout fifo_data 0 8 }  { in_V_id_V2_empty_n fifo_status 0 1 }  { in_V_id_V2_read fifo_update 1 1 } } }
	in_V_dest_V3 { ap_fifo {  { in_V_dest_V3_dout fifo_data 0 8 }  { in_V_dest_V3_empty_n fifo_status 0 1 }  { in_V_dest_V3_read fifo_update 1 1 } } }
	in_V_user_V4 { ap_fifo {  { in_V_user_V4_dout fifo_data 0 16 }  { in_V_user_V4_empty_n fifo_status 0 1 }  { in_V_user_V4_read fifo_update 1 1 } } }
	in_V_last_V5 { ap_fifo {  { in_V_last_V5_dout fifo_data 0 1 }  { in_V_last_V5_empty_n fifo_status 0 1 }  { in_V_last_V5_read fifo_update 1 1 } } }
