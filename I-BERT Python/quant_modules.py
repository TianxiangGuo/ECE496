...
class IntSoftmax(nn.Module):
    ...
    def __init__(self, output_bit, quant_mode=False, force_dequant="none"):
        ...
        self.coef[1] /= self.coef[0]  # This makes a = 1, but the answer is now scaled by 1/a. Hence, in int_polynomial we multiply the resulting scaling factor by self.coef[0]
